    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/modernizr").Include(
                        "~/Scripts/modernizr-*"));
            bundles.Add(new ScriptBundle("~/bundles/jstree").Include("~/Scripts/JsTree/jstree.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include("~/Content/site.css", "~/Content/button/beautons.css","~/Content/base/menu.css"));
